...
&& ./bin/add-user-keycloak.sh --user admin --password $PASSWORD --realm master && touch /opt/keycloak-4.8.3.Final/password && cat $PASSWORD >> /opt/keycloak-4.8.3.Final/password
